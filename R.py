...
bot_token = '6927278021:AAEXrzJmshgf9tSaXrR8NiFXEqOa826cz4Y'
...
ADMIN_ID = 5951082609  # Replace with the actual admin's user ID
...
def handle_contact_admin(message):
    bot.reply_to(message, f"📞 @CYBERWAVE80: {ADMIN_ID}")
